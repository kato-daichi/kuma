...
enum { value_draw = 0, value_mate = 32000, value_inf = 32001, undefined = 32002, timeout = 32003, won_endgame = 10000, mate_in_max_ply = value_mate - max_ply, value_mated = -32000,
...
enum piece_code { blank, wpawn = 2, bpawn, wknight, bknight, wbishop, bbishop, wrook, brook, wqueen, bqueen, wking, bking };
