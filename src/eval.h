...
inline constexpr int scale_hardtowin = 4;
inline constexpr int scale_nopawns = 1;
inline constexpr int scale_normal = 28;
inline constexpr int scale_ocb = 12;
inline constexpr int scale_ocb_pieces = 24;
inline constexpr int scale_onepawn = 8;
