...
public:
	...
	[[nodiscard]] bool test_repetition() const;
...
{
	return (kingblockers[~active_side][0] | kingblockers[~active_side][1]) & BITSET(from_sq(m));
}
//-------------------------------------------//
